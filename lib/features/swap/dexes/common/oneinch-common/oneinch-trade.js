...
var OneinchTrade = /** @class */ (function (_super) {
    ...
    OneinchTrade.prototype.getTradeData = function (fromAddress) {
        var swapRequest = {
            params: __assign({ fromTokenAddress: this.nativeSupportedFrom.address, toTokenAddress: this.nativeSupportedTo.address, amount: this.nativeSupportedFrom.stringWeiAmount, slippage: (this.slippageTolerance * 100).toString(), fromAddress: fromAddress || this.walletAddress }, (this.disableMultihops && { mainRouteParts: '1' }))
        };
