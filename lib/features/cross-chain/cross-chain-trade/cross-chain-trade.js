...
var CrossChainTrade = /** @class */ (function () {
    function CrossChainTrade(crossChainTrade) {
        ...
        var fromSlippage = this.fromTrade instanceof instant_trade_contract_trade_1.InstantTradeContractTrade
            ? this.fromTrade.slippageTolerance
            : 0;
        this.to = new price_token_amount_1.PriceTokenAmount(__assign(__assign({}, this.toTrade.toToken.asStruct), { weiAmount: this.toTrade.toToken.weiAmountPlusSlippage(fromSlippage) }));
